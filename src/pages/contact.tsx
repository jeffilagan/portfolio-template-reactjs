                            ...
                            <div className="contact-items">
                                <div className="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:your@email.com" className="text-white text-decoration-none">
                                            your@email.com
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="text-white text-decoration-none">
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white mb-0">Your City, Country</p>
                                    </div>
                                </div>
                            </div>
                            
                            <div className="social-links mt-4">
                                <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="text-white me-4 fs-4">
                                    <FaGithub />
                                </a>
                                <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="text-white me-4 fs-4">
                                    <FaLinkedin />
                                </a>
